...
Ext.onReady(function() {
	...
	function initWindow1() {
		var firstWindow = new Ext.Window({
			title : '<span class="commoncss">工作流监控</span>', // 窗口标题
			iconCls : 'imageIcon',
			layout : 'fit', // 设置窗口布局模式
			width : 745, // 窗口宽度
			height : 320, // 窗口高度
			...
			// 设置窗口是否可以溢出父容器
			buttonAlign : 'center',
			//items:[title : '图片浏览',html : '<img src="/demo/workflow.jpg"/>'],
			items:[{
				//title : '图片浏览',
                //xtype:'panel',
                html:'<img id="checkpic" src="/demo/workflow.jpg" style="width:729px;height:263px;"/>'  
            }],
			buttons : [  {
				text : '关闭',
				iconCls : 'deleteIcon',
